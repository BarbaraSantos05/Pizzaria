...
Namespace ClassesGenerica
    Public Class Connection
        ...
        Private Sub Inicializa()
            ...
            Dim connectionString = "SERVER=localhost;DATABASE=bd_pizzaria_barbara;UID=ddsinfo;PWD=dds21231;Port=3307"
        ...
        Public Sub InserirParametroNoCamando(ByVal valor As Object, ByVal nome As String,
                                  ByVal tipoDb As DbType)
            Try
                Dim myParam As New MySqlParameter
                myParam.Value = valor
                myParam.ParameterName = nome
